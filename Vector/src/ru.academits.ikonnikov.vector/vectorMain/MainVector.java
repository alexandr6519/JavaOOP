...
public class MainVector {
    public static void main(String[] args) throws RuntimeException {
        ...
        System.out.println("The result of subtraction of vector v2 from v1 by nonstatic method is: " + v1.subtract(v2).toString());

        System.out.println("The result of subtraction of vector v2 from v1 by static method is: " + subtract(v1, v2).toString());

        System.out.println("The result of multiplication of vector v2 by scalar (3,30) is: " + v2.multiplyByScalar(3.3).toString());
        System.out.println("The result of multiplication of vector v2 by scalar (-0,50) is: " + v2.multiplyByScalar(-0.5).toString());
