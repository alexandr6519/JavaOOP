...
public class MainVector {
    public static void main(String[] args) throws NullPointerException {
        ...
        System.out.println("Vector v5 is copy of v4 : " + v5.toString());
        ...
        System.out.println("The result of subtraction of vector v2 and v1 by nonstatic method is: " + v1.subtract(v2).toString());
        System.out.println("The result of subtraction of vector v2 and v1 by static method is: " + subtract(v1, v2).toString());
        System.out.println("The result of multiplication of vector v3 by scalar (3,30) is: " + v3.multiplyByScalar(3.3).toString());
        System.out.println("The result of multiplication of vector v3 by scalar (-0,50) is: " + v3.multiplyByScalar(-0.5).toString());
        System.out.printf("The result of scalar multiplication of vectors v2 and v3 = %.2f %n", multiplyScalar(v2, v3));
        System.out.println("The result of comparing vectors v2 and v4 is: " + v4.equals(v2));
        System.out.println("The result of comparing vectors v4 and v5 is: " + v4.equals(v5));
